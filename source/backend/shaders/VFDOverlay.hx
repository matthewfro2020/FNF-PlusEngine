...
/**
 * VFD (Vacuum Fluorescent Display) overlay shader
 * Creates a retro hexagonal grid effect for the preloader
 * Ported from base game's FunkinPreloader
 */
class VFDOverlay extends FlxShader
{
